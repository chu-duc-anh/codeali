...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "The number of times I love you " + (thePercent+9899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Cứ khen ALI mãi như thế thì cảm thấy thừa mất:';
document.querySelector('.Description .modal-body').innerHTML = 'Nhưng nếu đặt ALI vào tim, chắc chắn là vừa nhất <i class="fas fa-heart"></i> ';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";

author.innerHTML = "facebook của BROWN: <a href='https://www.facebook.com/buntom.0409//'>Đức Aanh<a>";
